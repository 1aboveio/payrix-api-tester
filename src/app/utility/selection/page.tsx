      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Poll the lane for selection status. Supports optional query parameters for form configuration.
            Use <code>|</code> to separate multi-line text lines and options.
          </p>
          <TemplateSelector
          ...
          >
            ...
            <div className="space-y-2">
              <Label htmlFor="multiLineText">
                Multi-Line Text <span className="text-xs text-muted-foreground">(use | to separate lines)</span>
              </Label>
              <Input 
                id="multiLineText" 
                value={multiLineText} 
            ...
            <div className="space-y-2">
              <Label htmlFor="options">
                Options <span className="text-xs text-muted-foreground">(use | to separate options)</span>
              </Label>
              <Input 
                id="options" 
                value={options} 
