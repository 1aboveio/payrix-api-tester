...
test.describe('Checkout Flow - Smoke Tests', () => {
  ...
  test('checkout page route exists for subscription parameter', async ({ page }) => {
    await page.goto('/platform/checkout?subscriptionId=test123');
    await waitForAppReady(page);
  ...
  test('checkout page route exists without parameters', async ({ page }) => {
    await page.goto('/platform/checkout');
    await waitForAppReady(page);
  ...
  test('confirmation page route exists for subscription', async ({ page }) => {
    await page.goto('/platform/checkout/confirmation?subscriptionId=test123&tokenId=test456');
    await waitForAppReady(page);
